module.exports = {
    ...
    'sample app caller' : function (client) {
      ...
      client
        ...
        .setValue('//*[@id="normal_login_username"]', "scaletest007@gmail.com")
        ...
        .setValue('/html/body/div[2]/div/div[2]/div/div[2]/div[1]/div[1]/div/div[4]/input', "scaletest008@gmail.com")
